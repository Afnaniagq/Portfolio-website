...
function Hero(){
    return(
        <div className="bg-[url('/cover.avif')] h-screen bg-cover flex items-center">
    <div className="container mx-auto px-4">
        <div className="max-w-[450px] text-gray-900 flex flex-col gap-[20px]">
            <div>
        <h2 className="text-3xl md:text-4xl mb-3 font-medium text-black flex duration-1000 font-serif">Welcome to My portfolio</h2>
        <Type/>
</div>
<div className="bg-[#ff4d41] h-[3px] w-[90px]"></div>
<div>
    <p className="my-3 text-black  font-bold text-md  hover:translate-x-12 bottom-8  duration-1000">I have developed a strong foundation in HTML, CSS, and JavaScript, along with experience in using Tailwind CSS and Next.js to create responsive and engaging web applications.</p>
    <button className="bg-orange-500 hover:bg-orange-400 hover:text-[20px] rounded-md h-14 w-44  text-[18px] text-white">Learn More</button>
</div>
