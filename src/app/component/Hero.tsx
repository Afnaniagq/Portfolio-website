...
function Hero() {
    return (
        <div className="bg-[url('/cha.jpg')] h-screen bg-cover bg-no-repeat bg-center opacity-95 flex items-center">
            <div className="container mx-auto px-4">
                <div className="max-w-[450px] text-gray-900 flex flex-col gap-[20px]">
                    ...
                    <div>
                        <p className="my-3 text-white font-bold text-md sm:text-lg md:text-xl hover:translate-x-12 bottom-8 duration-1000">
                            I have developed a strong foundation in HTML, CSS, and JavaScript, along with experience in using Tailwind CSS and Next.js to create responsive and engaging web applications.
                        </p>
                        <button className="bg-orange-600 hover:bg-orange-400 hover:text-[20px] rounded-md h-14 w-44 text-[18px] text-white">
                            Learn More
                        </button>
                    </div>
                    <ul className="space-y-[15px] ml-auto absolute right-2 sm:right-4 md:right-8">
